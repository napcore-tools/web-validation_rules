...
resource: https://gtfs-validator.mobilitydata.org/rules.html#fare_transfer_rule_missing_transfer_count-rule
tags:
- mobilitydata
- gtfs
- integrity
...
[1] [fare_transfer_rule_missing_transfer_count rule reference](https://gtfs-validator.mobilitydata.org/rules.html#fare_transfer_rule_missing_transfer_count-rule)
