...
resource: https://gtfs-validator.mobilitydata.org/rules.html#forbidden_continuous_pickup_drop_off-rule
tags:
- mobilitydata
- gtfs
- integrity
...
[1] [forbidden_continuous_pickup_drop_off rule reference](https://gtfs-validator.mobilitydata.org/rules.html#forbidden_continuous_pickup_drop_off-rule)
